...
/// <summary>
/// Domain event published through the transactional outbox when a currency is created
/// (SDD-NOM-001 §2.1, SDD-INFRA-006 §2.2).
...
/// </summary>
public sealed record CurrencyCreatedEvent : IFinanceEvent
{
    /// <inheritdoc />
    ...
    /// <summary>Surrogate identifier of the created currency.</summary>
    public required int CurrencyId { get; init; }

    /// <summary>ISO 4217 alphabetic code of the created currency.</summary>
    ...
    /// <summary>Whether the currency is active.</summary>
