...
/// <summary>
/// Domain event published through the transactional outbox when a chart-of-accounts account is created
/// (SDD-ACCT-001 §2.8, SDD-INFRA-006 §2.2).
...
/// </summary>
public sealed record AccountCreatedEvent : IFinanceEvent
{
    /// <inheritdoc />
    ...
    /// <summary>Surrogate identifier of the created account.</summary>
