...
/// <summary>
/// Provides the authenticated user's identity for audit recording (SDD-AUDIT-001 §2.3). Resolves the
/// stable user identifier and display name from the ambient <c>ClaimsPrincipal</c> established by the
/// shared JWT authentication (SDD-INT-AUTH-001).
/// </summary>
