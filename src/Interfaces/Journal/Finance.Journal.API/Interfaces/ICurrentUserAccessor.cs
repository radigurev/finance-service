...
/// <summary>
/// Provides the authenticated user's identity for audit recording and posting stamps (SDD-AUDIT-001 §2.3,
/// SDD-FIN-002 §2.4). Resolves the stable user identifier and display name from the ambient
