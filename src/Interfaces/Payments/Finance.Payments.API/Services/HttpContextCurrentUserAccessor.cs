...
/// <summary>
/// <see cref="IHttpContextAccessor"/>-backed <see cref="ICurrentUserAccessor"/> that reads the authenticated
/// user's identity from the JWT claims established by the shared authentication (SDD-INT-AUTH-001,
/// SDD-AUDIT-001 §2.3). Falls back to the system identity for the event-driven back-event path where no HTTP
